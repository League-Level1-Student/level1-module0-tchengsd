	...
	private void startQuiz() {
		...
		for (int i = 0; i < 4; i++) {
			...
			if (i == 0 && guess.equals("Arnold")) {
				JOptionPane.showMessageDialog(null, "UwU! You are right!");
				theScore--;
			...
			// -- Tell them they are wrong and who the person is
				...
				JOptionPane.showMessageDialog(null, "You are wrong. No UwU for you :(");
			}
			// 7. Use the showNextImage() method below to get the next image
			showNextImage();
			// 8. Show them their current score
			JOptionPane.showMessageDialog(null, "Score = " + theScore);

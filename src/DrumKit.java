...
public class DrumKit implements MouseListener {
	...
	private void getGoing() throws MalformedURLException {
		...
		String imagetwo = "snare.jpg";
		// 9. Edit the next line to use your String variable
		drumLabelWithImage = createLabelImage(image);
		drumLabelTwo = createLabelImage(imagetwo);
		// 10. Add the image to the panel
		sample.add(drumLabelWithImage);
		sample.add(drumLabelTwo);
		...
		drumLabelTwo.addMouseListener(this);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (drumClicked.equals(drumLabelTwo)) {

			// 18. ...use the playSound method to play a drum sound. Test to see if it works
